...
func TestLoadFromFS_Basic(t *testing.T) {
	...
	mustWrite(t, root, ".saker/agents/helper.md", content)
...
func TestLoadFromFS_IgnoresUserDir(t *testing.T) {
	...
	mustWrite(t, userHome, ".saker/agents/user-only.md", strings.Join([]string{
		"---",
		"name: user-only",
	...
	mustWrite(t, projectRoot, ".saker/agents/shared.md", strings.Join([]string{
		"---",
		"name: shared",
...
func TestLoadFromFS_YAML(t *testing.T) {
	...
	path := mustWrite(t, root, ".saker/agents/ignored.md", body)
...
func TestLoadFromFS_MetadataParsing(t *testing.T) {
	...
	mustWrite(t, root, ".saker/agents/worker.md", body)
...
func TestLoadFromFS_Errors(t *testing.T) {
	root := t.TempDir()
	mustWrite(t, root, ".saker/agents/bad name.md", strings.Join([]string{
		"---",
		"description: missing name uses fallback",
		"---",
		"body",
	}, "\n"))
	mustWrite(t, root, ".saker/agents/broken.md", "---\nname: ok\n")
	mustWrite(t, root, ".saker/agents/good.md", strings.Join([]string{
		"---",
		"name: good",
		"description: ok",
		"---",
...
func TestLoadFromFS_ModelValidationError(t *testing.T) {
	root := t.TempDir()
	mustWrite(t, root, ".saker/agents/invalid-model.md", strings.Join([]string{
		"---",
		"name: invalid-model",
