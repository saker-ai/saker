...
func TestParse_Skills(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/test-skill/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: test-skill
...
func TestParse_Commands(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/test-cmd.md": &fstest.MapFile{
			Data: []byte(`---
name: test-cmd
...
func TestParse_Subagents(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/test-agent.md": &fstest.MapFile{
			Data: []byte(`---
name: test-agent
...
func TestParse_Hooks(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/hooks/hooks.json": &fstest.MapFile{
			Data: []byte(`{
	"PreToolUse": [
...
func TestParse_HooksFromShellScripts(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/hooks/pre-tool-use.sh": &fstest.MapFile{
			Data: []byte(`#!/bin/bash
echo "pre-tool-use"
`),
		},
...
func TestParse_ValidationErrors(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/invalid/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: INVALID_NAME
...
func TestParse_DuplicateSkills(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/duplicate/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: duplicate
...
`),
		...
		".saker/skills/duplicate2/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: duplicate
...
func TestParse_CommandWithoutFrontmatter(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/simple.md": &fstest.MapFile{
...
func TestParse_SkillMissingFrontmatter(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/bad/SKILL.md": &fstest.MapFile{
...
func TestParse_SkillWithAllMetadata(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/full-skill/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: full-skill
...
func TestParse_CommandWithAllMetadata(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/full-cmd.md": &fstest.MapFile{
			Data: []byte(`---
name: full-cmd
...
func TestParse_SubagentWithAllMetadata(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/full-agent.md": &fstest.MapFile{
			Data: []byte(`---
name: full-agent
...
func TestParse_SubagentInvalidModel(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/bad-model.md": &fstest.MapFile{
			Data: []byte(`---
name: bad-model
...
func TestParse_SkillHandlerExecution(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/exec-skill/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: exec-skill
...
func TestParse_CommandHandlerExecution(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/exec-cmd.md": &fstest.MapFile{
			Data: []byte(`---
name: exec-cmd
description: Test handler execution
---
...
func TestParse_SubagentHandlerExecution(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/exec-agent.md": &fstest.MapFile{
			Data: []byte(`---
name: exec-agent
description: Test handler execution
---
...
func TestParse_ToolListYAMLSequence(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/yaml-list/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: yaml-list
...
func TestParse_SubagentInheritModel(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/inherit-agent.md": &fstest.MapFile{
			Data: []byte(`---
name: inherit-agent
...
func TestParse_SubagentMissingFrontmatter(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/bad.md": &fstest.MapFile{
			Data: []byte(`No frontmatter here.`),
		},
	}
...
func TestParse_SubagentInvalidPermissionMode(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/bad-perm.md": &fstest.MapFile{
			Data: []byte(`---
name: bad-perm
...
func TestParse_SkillUnclosedFrontmatter(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/unclosed/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: unclosed
...
func TestParse_CommandUnclosedFrontmatter(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/unclosed.md": &fstest.MapFile{
			Data: []byte(`---
name: unclosed
description: Missing closing separator
`),
...
func TestParse_SubagentUnclosedFrontmatter(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/unclosed.md": &fstest.MapFile{
			Data: []byte(`---
name: unclosed
description: Missing closing separator
`),
...
func TestParse_SkillInvalidYAML(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/bad-yaml/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: [invalid yaml
---
Body
...
func TestParse_ToolListInvalidType(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/bad-tools/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: bad-tools
...
func TestParse_ToolListSequenceWithInvalidEntry(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/bad-entry/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: bad-entry
...
func TestParse_HooksUnknownEventFromFilename(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/hooks/unknown-event.sh": &fstest.MapFile{
			Data: []byte(`#!/bin/bash
echo "unknown"
`),
		},
...
func TestParse_SkillValidationDescriptionTooLong(t *testing.T) {
	...
	fsys := fstest.MapFS{
		".saker/skills/long-desc/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: long-desc
...
func TestParse_SkillValidationCompatibilityTooLong(t *testing.T) {
	...
	fsys := fstest.MapFS{
		".saker/skills/long-compat/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: long-compat
...
func TestParse_SkillValidationMissingDescription(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/no-desc/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: no-desc
---
Body
...
func TestParse_SubagentValidationMissingDescription(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/no-desc.md": &fstest.MapFile{
			Data: []byte(`---
name: no-desc
---
Body
...
func TestParse_SubagentValidationInvalidName(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/INVALID.md": &fstest.MapFile{
			Data: []byte(`---
name: INVALID_NAME
description: Test
---
...
func TestParse_CommandValidationInvalidName(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/INVALID NAME.md": &fstest.MapFile{
			Data: []byte(`---
name: INVALID NAME
description: Test
---
...
func TestParse_CommandNoArguments(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/no-args.md": &fstest.MapFile{
			Data: []byte(`---
name: no-args
...
func TestParse_ToolListNullValue(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/null-tools/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: null-tools
...
func TestParse_ToolListEmptyString(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/skills/empty-tools/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: empty-tools
...
func TestParse_SkillValidationMissingName(t *testing.T) {
	...
	fsys := fstest.MapFS{
		".saker/skills/test/SKILL.md": &fstest.MapFile{
			Data: []byte(`---
name: ""
...
func TestParse_DuplicateCommands(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/dup.md": &fstest.MapFile{
			Data: []byte(`---
name: dup
description: First
---
...
`),
		...
		".saker/commands/sub/dup.md": &fstest.MapFile{
			Data: []byte(`---
name: dup
description: Second
---
...
func TestParse_DuplicateSubagents(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/dup.md": &fstest.MapFile{
			Data: []byte(`---
name: dup
description: First
---
...
`),
		...
		".saker/agents/sub/dup.md": &fstest.MapFile{
			Data: []byte(`---
name: dup
description: Second
---
...
func TestParse_SubagentEmptyModel(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/no-model.md": &fstest.MapFile{
			Data: []byte(`---
name: no-model
...
func TestParse_CommandInvalidYAML(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/commands/bad-yaml.md": &fstest.MapFile{
			Data: []byte(`---
name: [invalid
---
Body
...
func TestParse_SubagentInvalidYAML(t *testing.T) {
	fsys := fstest.MapFS{
		".saker/agents/bad-yaml.md": &fstest.MapFile{
			Data: []byte(`---
name: [invalid
---
Body
