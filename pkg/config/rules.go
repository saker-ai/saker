...
// Rule represents a single project rule loaded from .saker/rules.
type Rule struct {
...
// RulesLoader loads markdown rules under .saker/rules and watches for changes.
...
func (l *RulesLoader) rulesDir() string {
	...
	return filepath.Join(root, ".saker", "rules")
}
