...
/**
 * Dashed edge indicating a context/citation reference relationship
 * (e.g., an agent referencing content from a previous turn).
 */
export function ContextEdge(props: EdgeProps) {
  const {
    id,
    selected,
    sourceX,
